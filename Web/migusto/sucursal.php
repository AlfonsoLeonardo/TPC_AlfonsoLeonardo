...
<head>
    ...
    <link rel="stylesheet" href="../../content/datalive-bootstrap-theme.css" />
...
<body>
      ...
      {
        return 'https://datalivecloud.com/migusto/sistema/prd/APP/app_config_read_ajax.php';      }
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="menu">
                            <div id="productosContainer" class="inner-tab-content">
                                <img src="../content/content_loading.gif">
                                <br>
                                <img src="../content/content_loading.gif">
                                <br>
                                <img src="../content/content_loading.gif">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="sucursal">
                            <div class="inner-tab-content">
                                ...
                                <section class="grey-box">
                                    <h3><img id="datalive-logo" src="https://migusto.com.ar/assets/images/logo.png" width="60px" /> Horarios</h3>
                                    <div id="schedule">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js" integrity="sha384-aJ21OjlMXNL5UyIl/XNwTMqvzeRMZH2w8c5cRVpzpU8Y5bApTppSuUkhZXN0VxHd" crossorigin="anonymous"></script>
    ...
    <script src="../../scripts/sucursal.js?V6"></script>
